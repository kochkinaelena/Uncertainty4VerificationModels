...
#    
    feature_set_list = [ text+attachments, text+punctuation+lexicon+src_SpeechAct+attachments,
                         text+punctuation+lexicon+src_SpeechAct+attachments+interactions]
    
    feature_name_list = [ 'text+attachments', 'text+punctuation+lexicon+src_SpeechAct+attachments',
                         'text+punctuation+lexicon+src_SpeechAct+attachments+interactions']
